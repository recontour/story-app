    ...
    try {
      ...
      if (history.length === 0) {
        prompt = `
          ...
          IMPORTANT: Ensure 'Choice A text' and 'Choice B text' are descriptive and can never be more than 100 charecters or 15 words, not more, fitting neatly on two lines in a large button container.
        ...
        prompt = `
          ...
          IMPORTANT: Ensure 'Choice A text' and 'Choice B text' are descriptive and can never be more than 100 charecters or 15 words, fitting neatly on two lines in a large button container.
        `;
      }
